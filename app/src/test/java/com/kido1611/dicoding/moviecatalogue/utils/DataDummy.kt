    ...
    fun generateDummyMovies(): List<Movie> {
        ...
        list.add(
            Movie(
                ...
                first_air_date = null,
                genre_ids = listOf(18, 10749, 10402),
                genres = null,
                id = 332562,
                name = null,
    ...
    fun generateDummyTv(): List<Movie> {
        ...
        list.add(
            Movie(
                ...
                genre_ids = listOf(16, 10759, 10765),
                genres = null,
                id = 12609,
                name = "Dragon Ball",
                ...
                popularity = 12.762,
                poster_path = "/tZ0jXOeYBWPZ0OWzUhTlYvMF7YR.jpg",
                release_date = null,
                title = null,
                vote_average = 8.1,
                vote_count = 1757
        ...
        list.add(
            Movie(
                ...
                genre_ids = listOf(10759, 16, 35, 10765, 9648),
                genres = null,
                id = 46261,
                name = "Fairy Tail",
                original_language = "ja",
                ...
                popularity = 44.372,
                poster_path = "/jsYTctFnK8ewomnUgcwhmsTkOum.jpg",
                release_date = null,
                title = null,
                vote_average = 7.8,
                vote_count = 598
        ...
        list.add(
            Movie(
                backdrop_path = "/eyO5b3b3wgfiyuIKQMAyekh40A2.jpg",
        ...
        list.add(
            Movie(
                ...
                genre_ids = listOf(10765, 18, 10759),
                genres = null,
                id = 1399,
        ...
        list.add(
            Movie(
                backdrop_path = "/7QSM3AsgWXctWBm7OFov9dGdZgt.jpg",
                first_air_date = "2014-09-22",
                genre_ids = listOf(18, 80, 10765),
                genres = null,
                id = 60708,
                name = "Gotham",
                original_language = "en",
